...
const promote_admin_dto_1 = require("./dto/promote-admin.dto");
...
let AuthController = class AuthController {
    ...
    async promoteToAdmin(promoteAdminDto) {
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Request OTP for passwordless login' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'OTP verified, login successful' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Promote user to admin (requires ADMIN_SECRET_KEY in body)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User promoted to admin' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid admin secret key' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [promote_admin_dto_1.PromoteAdminDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "promoteToAdmin", null);
